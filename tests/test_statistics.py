...
from datatrader.statistics.simple import SimpleStatistics
...
class TestSimpleStatistics(unittest.TestCase):
    """
    Verifica le statistiche su un portafoglio composto
    da AMZN e GOOG con vari ordini per creare trade round
    trip per entrambi.

    Esegue un semplice e breve backtest e controlla
    l'aritmetica per calcoli della equity, dei rendimenti
    e dei drqwdown lungo il percorso.
    ...
    def test_calculating_statistics(self):
        """
        Acquista/Vende più lotti di AMZN, GOOG a vari
        prezzi / commissioni per garantire che l'aritmetica
        nel calcolo dell'equity, dei drawdown e dello
        sharpe ratio sia corretta.
        """
        # Crea oggetto Statistics
        ...
        # Verifica che l'inizializzazione fosse corretta
        ...
        # Esegue transazioni e statistiche di test su questo tick
        ...
        # Verifica che i risultati siano calcolati correttamente.
